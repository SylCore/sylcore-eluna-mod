...
namespace LuaPet
{
    ...
    /**
     * Returns the maximum number of talents points available at the specified level.
     *
     * @param uint8 level : the level to check
     * @return uint8 maxTalentPoints : the maximum number of talent points for that level
     */
    ...
    /**
     * Returns the number of talent the [Pet] has used.
     *
